...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_cache" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5dd6edde#;
   pragma Export (C, u00001, "test_cacheB");
   ...
   u00141 : constant Version_32 := 16#53f6c941#;
   pragma Export (C, u00141, "adresse_ipB");
   u00142 : constant Version_32 := 16#f23ba643#;
   pragma Export (C, u00142, "adresse_ipS");
   u00143 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00143, "system__concat_7B");
   u00144 : constant Version_32 := 16#5e1dcd02#;
   pragma Export (C, u00144, "system__concat_7S");
   u00145 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00145, "system__concat_6B");
   u00146 : constant Version_32 := 16#701dbbaf#;
   pragma Export (C, u00146, "system__concat_6S");
   u00147 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00147, "system__concat_5B");
   u00148 : constant Version_32 := 16#2584d533#;
   pragma Export (C, u00148, "system__concat_5S");
   u00149 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00149, "system__concat_4B");
   u00150 : constant Version_32 := 16#dcbebd3d#;
   pragma Export (C, u00150, "system__concat_4S");
   u00151 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00151, "system__concat_3B");
   u00152 : constant Version_32 := 16#a9aacab8#;
   pragma Export (C, u00152, "system__concat_3S");
   u00153 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00153, "system__concat_2B");
   u00154 : constant Version_32 := 16#a07a41cd#;
   ...
   u00157 : constant Version_32 := 16#fbf1503f#;
   pragma Export (C, u00157, "cache_listeB");
   u00158 : constant Version_32 := 16#14c35228#;
   pragma Export (C, u00158, "cache_listeS");
   u00159 : constant Version_32 := 16#35cb9f17#;
   pragma Export (C, u00159, "cache_exceptionS");
   u00160 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00160, "system__assertionsB");
   u00161 : constant Version_32 := 16#6f8b84a5#;
   pragma Export (C, u00161, "system__assertionsS");
   u00162 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00162, "ada__assertionsB");
   u00163 : constant Version_32 := 16#d1602bfd#;
   pragma Export (C, u00163, "ada__assertionsS");
   ...
   u00170 : constant Version_32 := 16#cafa918a#;
   pragma Export (C, u00170, "system__storage_pools__subpools__finalizationB");
   u00171 : constant Version_32 := 16#8bd8fdc9#;
