...
%     xlabel("Temps(s)");
%     ylabel("Amplitude");
%     title("Diagramme de l'oeuil de la chaine 1 avec bruit");
%     grid on;
...
%     xlabel("Temps(s)");
%     ylabel("Amplitude");
%     title("Diagramme de l'oeuil de la chaine 2 avec bruit");
%     grid on;
...
%     diagramme_oeuil_3 = reshape(Signal_z3,Ns4air,floor(length(Signal_z3)/Ns4air)) ; 
%     figure(30+i);
%     plot(diagramme_oeuil_3);
%     xlabel("Temps(s)");
%     ylabel("Amplitude");
%     title("Diagramme de l'oeuil de la chaine 3 avec bruit");
%     grid on;
